...
Class Q3ALiveComponentItem
{
    ...
    [String] $Base
    [String] $Executable
    Q3ALiveComponentItem([UInt32]$Index,[String]$Name,[String]$Path)
    {
        $This.Index      = $Index
        $This.Name       = $Name
        $This.Path       = $Path
        $This.Base       = "$Path\baseq3"
        $This.Executable = "$Path\{0}.exe" -f $This.Engine()
    }
    [String] Engine()
    {
...
Class Q3ALiveComponentList
{
    ...
    Add([String]$Name,[String]$Path)
    {
        $This.Output += $This.Q3ALiveComponentItem($This.Output.Count,$Name,$Path)
    }
    [Object] Q3ALiveComponentItem([UInt32]$Index,[String]$Name,[String]$Path)
    {
        Return [Q3ALiveComponentItem]::New($Index,$Name,$Path)
    }
    [String] ToString()
    {
...
Class Q3ALiveRadiantItem
{
    ...
    [String] $Q3Map2
    [String] $Bspc
    Q3ALiveRadiantItem([UInt32]$Index,[String]$Name,[String]$Fullname)
    {
        $This.Index    = $Index
        $This.Name     = $Name
        $This.Fullname = $Fullname
        ...
        If ($This.Exists)
        {
            ...
            $This.Q3Map2 = $This.Output | ? Name -eq "q3map2.exe" | % Fullname
            If ($This.Q3Map2.Count -gt 1)
            {
                $This.Q3Map2 = $This.Q3Map2 | ? { $_ -match "x64" }
            }
...
Class Q3ALiveRadiantList
{
    ...
    Add([String]$Name,[String]$Fullname)
    {
        $This.Output += $This.Q3ALiveRadiantItem($This.Output.Count,$Name,$Fullname)
    }
    [Object] Q3ALiveRadiantItem([UInt32]$Index,[String]$Name,[String]$Fullname)
    {
        Return [Q3ALiveRadiantItem]::New($Index,$Name,$Fullname)
    }
    [String] ToString()
    {
...
Class Q3ALiveDependencyItem
{
    ...
    [String]     $Directory
    [String]    $Executable
    Q3ALiveDependencyItem([UInt32]$Index,[String]$Name,[String]$Type,[String]$Version,[String]$Description,[String]$Hash,[String]$Source,[String]$Size)
    {
         $This.Index       = $Index
         $This.Name        = $Name
         $This.Type        = $Type
         ...
         $This.Source      = $Source
         $This.Size        = $Size
         $This.FileName    = $Source | Split-Path -Leaf
    ...
    Check()
    {
        $This.Installed    = [UInt32][System.IO.File]::Exists($This.Path())
    }
    [String] GetFileType()
    {
        Return @{ zip = "Archive" ; exe = "Executable" }[$This.FileName.Split(".")[0]]
    }
    [String] Path()
    {
...
Class Q3ALiveDependencyList
{
    ...
    [UInt32] $Selected
    [Object]   $Output
    Q3ALiveDependencyList([String]$Path)
    {
        $This.Path = $Path
        $This.Check()
    ...
    AddDependency([String]$Name,[String]$Type,[String]$Version,[String]$Description,[String]$Hash,[String]$Url,[String]$Size)
    {
        If ($Name -notin $This.Output.Name)
        {
            $This.Output += $This.Q3ALiveDependencyItem($This.Output.Count,$Name,$Type,$Version,$Description,$Hash,$Url,$Size)
        }
    }
    [String[]] Dependencies()
    {
    ...
    [Object] Q3ALiveDependencyItem([UInt32]$Index,[String]$Name,[String]$Type,[String]$Version,[String]$Description,[String]$Hash,[String]$Source,[String]$Size)
    {
        Return [Q3ALiveDependencyItem]::New($Index,$Name,$Type,$Version,$Description,$Hash,$Source,$Size)
    }
    [String] ToString()
    {
...
Class Q3ALiveController
{
    ...
    ConfigScan()
    {
        ...
        $Ctrl.Update(0,"Scanning [~] (Quake III Arena/Quake Live/7-Zip/ImageMagick)")
            ...
            0
            {
                ...
                If (!!$Q3A)
                {
                    ...
                    If ($Ctrl.CheckDirectory($Path) -and "quake3.exe" -in $Ctrl.GetFiles($Path).Name)
                    {
                        ...
                        $Ctrl.Component.Add("Q3A",$Hash.Q3A.Value)
            ...
            0
            {
                ...
                If (!!$Live)
                {
                    ...
                    If ($Ctrl.CheckDirectory($Path) -and "quakelive_steam.exe" -in $Ctrl.GetFiles($Path).Name)
                    {
                        ...
                        $Ctrl.Component.Add("Live",$Hash.Live.Value)
        ...
        # GtkRadiant
        If ($Hash.Gtk.Valid -and "GtkRadiant" -notin $Ctrl.Radiant.Output.Name)
        {
            $Ctrl.Radiant.Add("GtkRadiant",$Hash.Gtk.Value)
            $Ctrl.Update(0,"Radiant [+] GtkRadiant: $($Hash.Gtk.Value)")
        }
        # NetRadiant
        If ($Hash.Net.Valid -and "NetRadiant" -notin $Ctrl.Radiant.Output.Name)
        {
            $Ctrl.Radiant.Add("NetRadiant",$Hash.Net.Value)
            $Ctrl.Update(0,"Radiant [+] GtkRadiant: $($Hash.Net.Value)")
        }
        # NetRadiant-Custom
        If ($Hash.Garux.Valid -and "NetRadiant-Custom" -notin $Ctrl.Radiant.Output.Name)
        {
            $Ctrl.Radiant.Add("NetRadiant-Custom",$Hash.Garux.Value)
            $Ctrl.Update(0,"Radiant [+] GtkRadiant: $($Hash.Garux.Value)")
        }
        ...
        Switch ($Hash.Zip.Valid)
        {
            0
            {
                ...
                If (!!$7Zip)
                {
                    ...
                    If ($Ctrl.CheckDirectory($Path) -and "7z.exe" -in $Ctrl.GetFiles($Path).Name)
                    {
                        ...
                        # Assign dependency
                        $Item = $Ctrl.Dependency.Output | ? Name -eq 7Zip

                        $Item.Assign($Path,"7z.exe")
            ...
            1
            {
                ...
                $Item.Assign($Hash.Zip.Path,"7z.exe")

                $Ctrl.Update(0,"Dependency [+] 7-Zip: $($Hash.Zip.Path)")
            }
        }
        ...
        Switch ($Hash.Magick.Valid)
        {
            0
            {
                ...
                If (!!$Magick)
                {
                    ...
                    If ($Ctrl.CheckDirectory($Path) -and "magick.exe" -in $Ctrl.GetFiles($Path).Name)
                    {
                        ...
                        # Assign dependency
                        $Item = $Ctrl.Dependency.Output | ? Name -eq ImageMagick

                        $Item.Assign($Path,"magick.exe")
            ...
            1
            {
                ...
                $Item.Assign($Hash.Magick.Path,"magick.exe")

                $Ctrl.Update(0,"Dependency [+] ImageMagick: $($Hash.Zip.Path)")
            }
        }
