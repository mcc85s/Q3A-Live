...
Class Q3ALiveAssignmentEditResourceArchive
{
    [UInt32] $Index
    [String] $Type
    [String] $Modified
    ...
    [UInt32] $Exists
    [Object] $Output
    Q3ALiveAssignmentEditResourceArchive([UInt32]$Index,[String]$Fullname)
    {
        $This.Index        = $Index
        $This.Type         = "Archive"
...
Class Q3ALiveAssignmentResourceList
{
        ...
        If ($Fullname -notin $This.Output.Fullname)
        {
            ...
            If ($Object)
            {
                $Item = Switch ($Object.GetType().Name)
                {
                    ...
                    FileInfo
                    {
                        $This.Q3ALiveAssignmentEditResourceArchive($This.Output.Count,$Fullname)
                    }
                    Default
                    {
    ...
    [Object] Q3ALiveAssignmentEditResourceArchive([UInt32]$Index,[String]$Fullname)
    {
        Return [Q3ALiveAssignmentEditResourceArchive]::New($Index,$Fullname)
    }
...
Class Q3ALiveAssignmentEditShaderFileList
{
    ...
    [Object] $Asset
    [Object] $File
    Q3ALiveAssignmentEditShaderFileList([String]$DisplayName,[String]$Fullname)
    {
        $This.DisplayName = $DisplayName
        $This.Fullname    = $Fullname
        $This.Clear()
...
Class Q3ALiveAssignmentEditTextureFileList
{
    ...
    [Object] $Asset
    [Object] $File
    Q3ALiveAssignmentEditTextureFileList([String]$DisplayName,[String]$Fullname)
    {
        $This.DisplayName = $DisplayName
        $This.Fullname    = $Fullname
        $This.Clear()
...
Class Q3ALiveAssignmentEditItem
{
    ...
    SetSource([String]$Source)
    {
        ...
        # Map         = {} $Map.Source.Map
        # Levelshot   = {} $Map.Source.Levelshot
        # Arena       = {} $Map.Source.Script | ? Extension -eq Arena
        # Model       = {} $Map.Source.Model
        # Sound       = {} $Map.Source.Sound
        # Music       = {} $Map.Source.Music
        # Shader      = <Q3ALive.AssignmentEdit.Shader.FileList> $Map.Source.Script | ? Extension -eq Shader
        # Texture     = <Q3ALive.AssignmentEdit.Texture.FileList> $Map.Source.Texture
    ...
    SourceRefresh()
    {
        ...
        If ($xMap.Source.Exists)
        {
            ...
            #$xMap.GetShader()
            $xScript      = $xMap.Source.Output | ? DisplayName -eq "\scripts"

            $xMap.Shader  = $xMap.Q3ALiveAssignmentEditShaderFileList($xMap.DisplayName,$xScript.Fullname)

            $Hash = @{ }
            ForEach ($File in $xMap.Source.Script | ? Extension -eq Shader)
            {
            ...
            #$xMap.GetTexture()
            $xTexture     = $xMap.Source.Output | ? DisplayName -eq "\textures"

            $xMap.Texture = $xMap.Q3ALiveAssignmentEditTextureFileList($xMap.DisplayName,$xTexture.Fullname)

            $Hash     = @{ }
            ForEach ($File in $xMap.Source.Texture)
            {
    ...
    [Object] Q3ALiveAssignmentEditShaderFileList([String]$DisplayName,[String]$Fullname)
    {
        Return [Q3ALiveAssignmentEditShaderFileList]::New($DisplayName,$Fullname)
    }
    [Object] Q3ALiveAssignmentEditTextureFileList([String]$DisplayName,[String]$Fullname)
    {
        Return [Q3ALiveAssignmentEditTextureFileList]::New($DisplayName,$Fullname)
    }
