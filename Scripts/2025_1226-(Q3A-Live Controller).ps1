...
Try
{
    ...
    '            {',
    '                Output.Add(new AssignmentSelectFile(index++, file));',
    '            }',
    '        ',
    '            OnPropertyChanged("Output");',
    '            OnPropertyChanged("View");',
...
Class Q3ALiveXaml
{
    ...
    '                                                Width="20"/>',
    '                                                <DataGridCheckBoxColumn Header="T"',
    '                                                Binding="{Binding IsTexture}"',
    '                                                Width="20"/>',
    '                                                <DataGridCheckBoxColumn Header="V"',
    ...
    '                                        </Grid.RowDefinitions>',
    '                                        <DataGrid Grid.Row="0"',
    '                                      Name="AssignmentEditShaderOutput"',
    '                                      ItemsSource="{Binding Source={StaticResource AssignmentSelectView}}"',
    '                                      AutoGenerateColumns="False"',
    '                                      IsReadOnly="True"',
    '                                      SelectionUnit="FullRow"',
    ...
    '                                        </DataGrid>',
    '                                        <DataGrid Grid.Row="1"',
    '                                                  Name="AssignmentEditShaderItemOutput"',
    '                                                  AutoGenerateColumns="False"',
    '                                                  IsReadOnly="True"',
    '                                                  SelectionUnit="FullRow"',
    '                                                  SelectionMode="Extended"',
    ...
    '                                        </DataGrid>',
    '                                        <DataGrid Grid.Row="2"',
    '                                                  Name="AssignmentEditShaderItemContent"',
    '                                                  SelectionMode="Extended"',
    '                                                  HeadersVisibility="None">',
    '                                            <DataGrid.RowStyle>',
    '                                                <Style TargetType="{x:Type DataGridRow}">',
    ...
    '                                    <DataGrid Grid.Row="0"',
    '                                      Name="AssignmentEditTextureOutput"',
    '                                      ItemsSource="{Binding Source={StaticResource AssignmentSelectView}}"',
    '                                      AutoGenerateColumns="False"',
    '                                      IsReadOnly="True"',
    '                                      SelectionUnit="FullRow"',
...
Class Q3ALiveAssignmentEditAssetShader : Q3ALiveAssignmentEditAssetEntry
{
    Q3ALiveAssignmentEditAssetShader([UInt32]$Index,[Object]$File) : base([UInt32]$Index,[Object]$File)
    {

    }
    [String] ToString()
    {
        Return "<Q3ALive.AssignmentEdit.Shader>"
    }
}

Class Q3ALiveAssignmentEditAssetTexture : Q3ALiveAssignmentEditAssetEntry
{
    Q3ALiveAssignmentEditAssetTexture([UInt32]$Index,[Object]$File) : base([UInt32]$Index,[Object]$File)
    {

    }
    [String] ToString()
    {
        Return "<Q3ALive.AssignmentEdit.Texture>"
    }
}

Class Q3ALiveAssignmentEditAssetLevelshot : Q3ALiveAssignmentEditAssetEntry
{
    Q3ALiveAssignmentEditAssetLevelshot([UInt32]$Index,[Object]$File) : base([UInt32]$Index,[Object]$File)
    {
...
Class Q3ALiveAssignmentEditAssetArena : Q3ALiveAssignmentEditAssetEntry
{
    Q3ALiveAssignmentEditAssetArena([UInt32]$Index,[Object]$File) : base([UInt32]$Index,[Object]$File)
    {

    }
    [String] ToString()
    {
        Return "<Q3ALive.AssignmentEdit.Arena>"
    }
}

Class Q3ALiveAssignmentEditAssetSound : Q3ALiveAssignmentEditAssetEntry
{
    Q3ALiveAssignmentEditAssetSound([UInt32]$Index,[Object]$File) : base([UInt32]$Index,[Object]$File)
    {

    }
    [String] ToString()
    {
        Return "<Q3ALive.AssignmentEdit.Sound>"
    }
}

Class Q3ALiveAssignmentEditAssetModel : Q3ALiveAssignmentEditAssetEntry
{
    Q3ALiveAssignmentEditAssetModel([UInt32]$Index,[Object]$File) : base([UInt32]$Index,[Object]$File)
    {

    }
    [String] ToString()
    {
        Return "<Q3ALive.AssignmentEdit.Model>"
    }
}

Class Q3ALiveAssignmentEditAssetMusic : Q3ALiveAssignmentEditAssetEntry
{
    Q3ALiveAssignmentEditAssetMusic([UInt32]$Index,[Object]$File) : base([UInt32]$Index,[Object]$File)
    {

    }
    [String] ToString()
    {
        Return "<Q3ALive.AssignmentEdit.Music>"
    }
}

Class Q3ALiveAssignmentEditScriptContent
{
    [UInt32] $Index
    [String] $Line
    Q3ALiveAssignmentEditScriptContent([UInt32]$Index,[String]$Line)
    {
        $This.Index = $Index
        $This.Line  = $Line
    }
    [String] ToString()
    {
        Return "<Q3ALive.AssignmentEdit.Script.Content>"
    }
}

Class Q3ALiveAssignmentEditScript
{
    [String] $Type
    [String] $Name
    [String] $Fullname
    [UInt32] $Exists
    [Object] $Content
    Q3ALiveAssignmentEditScript([String]$Type,[Object]$Asset)
    {
        $This.Type     = $Type
    ...
    Populate([String[]]$Lines)
    {
        ...
        {
            $Hash.Add($Hash.Count,$This.Q3ALiveAssignmentEditScriptContent($Hash.Count,$Line))
        }
    ...
    [Object] Q3ALiveAssignmentEditScriptContent([UInt32]$Index,[String]$Line)
    {
        Return [Q3ALiveAssignmentEditScriptContent]::New($Index,$Line)
    }
    [String] ToString()
    {
        Return "<Q3ALive.AssignmentEdit.Script>"
    }
}

Class Q3ALiveAssignmentEditArena : Q3ALiveAssignmentEditScript
{
    Q3ALiveAssignmentEditArena([String]$Type,[Object]$Asset) : base([String]$Type,[Object]$Asset)
    {
...
Class Q3ALiveAssignmentEditShaderSubshader
{
    [String] $Shader
    [String] $Name
    [String] $DisplayName
    ...
    [String] $Fullname
    [UInt32] $Exists
    Q3ALiveAssignmentEditShaderSubshader([String]$DisplayName)
    {
        $This.DisplayName = $DisplayName
        $This.Name        = $DisplayName | Split-Path -Leaf
        $This.Shader      = $DisplayName | Split-Path
...
Class Q3ALiveAssignmentEditShaderItemFormatLine
{
    [UInt32] $Index
    [String] $Line
    Q3ALiveAssignmentEditShaderItemFormatLine([UInt32]$Index,[String]$Line)
    {
        $This.Index = $Index
        $This.Line  = $Line
    }
...
Class Q3ALiveAssignmentEditShaderItemFormat
{
    [UInt32] $Index
    [String] $DisplayName
    [Object] $Content
    Q3ALiveAssignmentEditShaderItemFormat([UInt32]$Index,[String]$DisplayName)
    {
        $This.Index       = $Index
        $This.DisplayName = $DisplayName
        $This.Content     = @( )
    ...
    Add([String]$Line)
    {
        $This.Content += $This.Q3ALiveAssignmentEditShaderItemFormatLine($This.Content.Count,$Line)
    }
    Format()
    {
    ...
    [Object] Q3ALiveAssignmentEditShaderItemFormatLine([UInt32]$Index,[String]$Line)
    {
        Return [Q3ALiveAssignmentEditShaderItemFormatLine]::New($Index,$Line)
    }
    [String] ToString()
    {
...
Class Q3ALiveAssignmentEditShaderItemLine
{
    [UInt32] $Index
    [String] $Line
    Q3ALiveAssignmentEditShaderItemLine([UInt32]$Index,[String]$Line)
    {
        $This.Index = $Index
        $This.Line  = $Line
    }
...
Class Q3ALiveAssignmentEditShaderItem
{
    [UInt32]         $File
    [UInt32]        $Index
    [String]  $DisplayName
    ...
    [Object]    $Subshader
    [Object]      $Content
    Q3ALiveAssignmentEditShaderItem([UInt32]$Index,[String]$DisplayName)
    {
        $This.Index       = $Index
    ...
    Add([String]$Line)
    {
        $This.Content    += $This.Q3ALiveAssignmentEditShaderItemLine($This.Content.Count,$Line)
    }
    [Object] Q3ALiveAssignmentEditShaderItemLine([UInt32]$Index,[String]$Line)
    {
        Return [Q3ALiveAssignmentEditShaderItemLine]::New($Index,$Line)
    }
    GetSubshader()
    {
        ...
        If ($xSubshader.Count -gt 0)
        {
            ...
            $This.Subshader = $Filter | % { $This.Q3ALiveAssignmentEditShaderSubshader($_) }
        }
    }
    [Object] Q3ALiveAssignmentEditShaderSubshader([String]$DisplayName)
    {
        Return [Q3ALiveAssignmentEditShaderSubshader]::New($DisplayName)
    }
    [String] ToString()
    {
        Return "<ShaderItem>"
...
Class Q3ALiveAssignmentEditShaderItemTemplate
{
    [UInt32]         $File
    [UInt32]        $Index
    [String]  $DisplayName
    ...
    [Object]    $Subshader
    [Object]      $Content
    Q3ALiveAssignmentEditShaderItemTemplate([UInt32]$File,[UInt32]$Index,[Object]$ShaderItem)
    {
        $This.File         = $File
        $This.Index        = $Index
        $This.DisplayName  = $ShaderItem.DisplayName
        $This.Name         = $ShaderItem.Name
        $This.Fullname     = $ShaderItem.Fullname
        $This.IsTexture    = $ShaderItem.IsTexture
        $This.IsVirtual    = $ShaderItem.IsVirtual
        $This.IsReferenced = $ShaderItem.IsReferenced
        $This.Subshader    = $ShaderItem.Subshader
        $This.Content      = $ShaderItem.Content
    }
    [String] ToString()
    {
        Return "<Shader.Item.Template>"
    }
}

Class Q3ALiveAssignmentEditShaderFileLine
{
    [UInt32]      $Index
    [Int32] $ShaderIndex
    [String]       $Line
    Q3ALiveAssignmentEditShaderFileLine([UInt32]$Index,[Int32]$ShaderIndex,[String]$Line)
    {
        $This.Index       = $Index
...
Class Q3ALiveAssignmentEditShaderFileItem
{
    [UInt32] $Index
    [String] $Modified
    [String] $Name
    ...
    [Object] $Content
    [Object] $Output
    Q3ALiveAssignmentEditShaderFileItem([UInt32]$Index,[Object]$Asset)
    {
        $This.Index       = $Index
        $This.Modified    = $Asset.Modified
        $This.Name        = $Asset.Name
        $This.Shader      = $Asset.Name -Replace ".shader",""
        $This.DisplayName = "\scripts\{0}" -f $Asset.Name
        $This.Fullname    = $Asset.Fullname
        $This.Refresh()
    }
    Refresh()
    {
        ...
        ForEach ($Line in $yContent)
        {
            If ($Line -in $Shaders)
            {
                $Hash.Add($Hash.Count,$This.Q3ALiveAssignmentEditShaderItemFormat($Hash.Count,$Line))
            }
        ...
        ForEach ($Line in $xContent)
        {
            ...
            {
                $ShaderIndex ++
                $Hash.Add($Hash.Count,$This.Q3ALiveAssignmentEditShaderItem($Hash.Count,$Line))
            }

            $sContent.Add($sContent.Count,$This.Q3ALiveAssignmentEditShaderFileLine($sContent.Count,$ShaderIndex,$Line))
            If ($ShaderIndex -ge 0)
            {
    ...
    [Object] Q3ALiveAssignmentEditShaderItemFormat([UInt32]$Index,[String]$DisplayName)
    {
        Return [Q3ALiveAssignmentEditShaderItemFormat]::New($Index,$DisplayName)
    }
    [Object] Q3ALiveAssignmentEditShaderFileLine([UInt32]$Index,[Int32]$ShaderIndex,[String]$Line)
    {
        Return [Q3ALiveAssignmentEditShaderFileLine]::New($Index,$ShaderIndex,$Line)
    }
    [Object] Q3ALiveAssignmentEditShaderItem([UInt32]$Index,[Object[]]$Line)
    {
        Return [Q3ALiveAssignmentEditShaderItem]::New($Index,$Line)
    }
    [String] ToString()
    {
...
Class Q3ALiveAssignmentEditShaderFileList
{
    [String] $DisplayName
    [String] $Fullname
    [Object] $Asset
    ...
    [Object] $Subshader
    [Object] $Output
    Q3ALiveAssignmentEditShaderFileList([String]$DisplayName,[String]$Fullname,[Object[]]$ShaderAsset)
    {
        $This.DisplayName = $DisplayName
        $This.Fullname    = $Fullname
    ...
    Refresh()
    {
        ...
        {
            $Hash.Add($Hash.Count,$This.Q3ALiveAssignmentEditShaderFileItem($Hash.Count,$Item))
        }
    ...
    {
        # Use -> $Map.Shader.Get("")
        Return $This.Shader.File.Output | ? DisplayName -match $Displayname
    }
    [Object] Copy([UInt32]$File,[UInt32]$Index,[Object]$ShaderItem)
    {
        Return $This.Q3ALiveAssignmentEditShaderItemTemplate($File,$Index,$ShaderItem)
    }
    [Object] Q3ALiveAssignmentEditShaderItemTemplate([UInt32]$File,[UInt32]$Index,[Object]$ShaderItem)
    {
        Return [Q3ALiveAssignmentEditShaderItemTemplate]::New($File,$Index,$ShaderItem)
    }
    [Object] Q3ALiveAssignmentEditShaderFileItem([UInt32]$Index,[Object]$Asset)
    {
        Return [Q3ALiveAssignmentEditShaderFileItem]::New($Index,$Asset)
    }
    [String] ToString()
    {
        Return "<Q3ALive.AssignmentEdit.Shader.FileList>"
    }
}

Class Q3ALiveAssignmentEditTextureFileItem
{
    [UInt32]        $Index
    [String]         $Type
    [String]     $Modified
    ...
    [String]     $Fullname
    [String]      $NewName
    Q3ALiveAssignmentEditTextureFileItem([UInt32]$Index,[Object]$Asset)
    {
        $This.Index       = $Index
...
Class Q3ALiveAssignmentEditTextureFileList
{
    [String] $DisplayName
    [String] $Fullname
    [Object] $Asset
    [Object] $File
    Q3ALiveAssignmentEditTextureFileList([String]$DisplayName,[String]$Fullname,[Object[]]$Asset)
    {
        $This.DisplayName = $DisplayName
        $This.Fullname    = $Fullname
        $This.Asset       = $Asset
    ...
    Refresh()
    {
        ...
        {
            $Hash.Add($Hash.Count,$This.Q3ALiveAssignmentEditTextureFileItem($Hash.Count,$File))
        }

        $This.File = Switch ($Hash.Count) { 0 { } 1 { $Hash[0] } Default { $Hash[0..($Hash.Count-1)] } }
    }
    [Object] Q3ALiveAssignmentEditTextureFileItem([UInt32]$Index,[Object]$File)
    {
        Return [Q3ALiveAssignmentEditTextureFileItem]::New($Index,$File)
    }
    [String] ToString()
    {
        Return "<Q3ALive.AssignmentEdit.Texture.FileList>"
    }
}
...
Class Q3ALiveAssignmentEditItemFolder
{
    [String]     $Type
    [String]     $Name
    [String] $Fullname
    [UInt32]   $Exists
    Q3ALiveAssignmentEditItemFolder([String]$Type,[String]$Fullname)
    {
        $This.Type     = $Type
...
Class Q3ALiveAssignmentEditItem
{
    ...
    {
        $This.Source      = $This.Q3ALiveAssignmentEditItemFolder("Source",$Source)

        $This.CheckAssetTypes("Source")

        $Assets = Get-ChildItem $This.Source.Fullname -Recurse | Sort-Object Fullname
        
        $Hash   = @{ }
        ForEach ($Asset in $Assets)
        {
            $Item             = $This.Q3ALiveAssignmentEditAssetEntry($Hash.Count,$Asset)
            $Item.SetDisplayName($Item.Fullname.Replace($This.Source.Fullname,""))
    ...
    {
        $This.Target   = $This.Q3ALiveAssignmentEditItemFolder("Target",$Target)

        $This.CheckAssetTypes("Target")

        # Only for transferring a compilation of stuff 
    }
    ...
    Refresh()
    {
        ...
        If ($Map.Exists)
        {
            ...
            If ($Map.Source.Exists)
            {
                ...
                # // Assign References
                $Map.QueryReferenceList()
            }
        }
    }
    GetShader()
    {
        $xScript      = $This.Output | ? DisplayName -eq "\scripts"
        $Shaders      = $This.FindShaders()

        $This.Shader  = $This.Q3ALiveAssignmentEditShaderFileList($This.DisplayName,$xScript.Fullname,$Shaders)
    }
    GetTexture()
    {
        $xTexture     = $This.Output | ? DisplayName -eq "\textures"
        $Textures     = $This.FindTextures()

        $This.Texture = $This.Q3ALiveAssignmentEditTextureFileList($This.DisplayName,$xTexture.Fullname,$Textures)
    }
    ...
    [Object] Q3ALiveAssignmentEditAssetEntry([UInt32]$Index,[Object]$Object)
    {
        Return [Q3ALiveAssignmentEditAssetEntry]::New($Index,$Object)
    }
    [Object] Q3ALiveAssignmentEditAssetShader([UInt32]$Index,[Object]$File)
    {
        Return [Q3ALiveAssignmentEditAssetShader]::New($Index,$File)
    }
    [Object] Q3ALiveAssignmentEditAssetTexture([UInt32]$Index,[Object]$File)
    {
        Return [Q3ALiveAssignmentEditAssetTexture]::New($Index,$File)
    }
    [Object] Q3ALiveAssignmentEditItemFolder([String]$Type,[String]$Fullname)
    {
        Return [Q3ALiveAssignmentEditItemFolder]::New($Type,$Fullname)
    }
    ...
    [Object] Q3ALiveAssignmentEditScript([String]$Type)
    {
        Return [Q3ALiveAssignmentEditScript]::New($Type)
    }
    [Object] Q3ALiveAssignmentEditScript([String]$Type,[String]$Path)
    {
        Return [Q3ALiveAssignmentEditScript]::New($Type,$Path)
    }
    [Object] Q3ALiveAssignmentEditArena([String]$Type)
    {
        Return [Q3ALiveAssignmentEditArena]::New($Type)
    }
    [Object] Q3ALiveAssignmentEditArena([String]$Type,[String]$Path)
    {
        Return [Q3ALiveAssignmentEditArena]::New($Type,$Path)
    }
    [Object] Q3ALiveAssignmentEditShaderFileList([String]$DisplayName,[String]$Fullname,[Object[]]$ShaderAssets)
    {
        Return [Q3ALiveAssignmentEditShaderFileList]::New($DisplayName,$Fullname,$ShaderAssets)
    }
    [Object] Q3ALiveAssignmentEditTextureFileList([String]$DisplayName,[String]$Fullname,[Object[]]$TextureAssets)
    {
        Return [Q3ALiveAssignmentEditTextureFileList]::New($DisplayName,$Fullname,$TextureAssets)
    }
    [Object] Q3ALiveAssignmentEditLevelshot([String]$Name,[String]$Path)
    {
        Return [Q3ALiveAssignmentEditLevelshot]::New($Name,$Path)
    }
    [Object] Q3ALiveAssignmentEditAssetLevelshot([UInt32]$Index,[Object]$File)
    {
        Return [Q3ALiveAssignmentEditAssetLevelshot]::New($Index,$File)
    }
    [Object] Q3ALiveAssignmentEditAssetArena([UInt32]$Index,[Object]$File)
    {
        Return [Q3ALiveAssignmentEditAssetArena]::New($Index,$File)
    }
    [Object] Q3ALiveAssignmentEditAssetSound([UInt32]$Index,[Object]$File)
    {
        Return [Q3ALiveAssignmentEditAssetSound]::New($Index,$File)
    }
    [Object] Q3ALiveAssignmentEditAssetModel([UInt32]$Index,[Object]$File)
    {
        Return [Q3ALiveAssignmentEditAssetModel]::New($Index,$File)
    }
    [Object] Q3ALiveAssignmentEditAssetMusic([UInt32]$Index,[Object]$File)
    {
        Return [Q3ALiveAssignmentEditAssetMusic]::New($Index,$File)
    }
    ...
    [Object[]] FindShaders()
    {
        $List = $This.Output | ? Label -eq Script | ? Extension -eq shader

        $Hash = @{ }
        ForEach ($File in $List)
        {
            $Item           = $This.Q3ALiveAssignmentEditAssetShader($Hash.Count,$File)
            $Item.SetDisplayName("\shaders\$($Item.Name)")
            $Item.Reference = "{0}" -f $Item.Name.Replace(".shader","")
            $Hash.Add($Hash.Count,$Item)
        }

        Return @(Switch ($Hash.Count) { 0 {  } 1 { $Hash[0] } Default { $Hash[0..($Hash.Count-1)]}})
    }
    [Object[]] FindTextures()
    {
        $xTexture = $This.Output | ? DisplayName -eq "\textures"
        $List     = $This.Output | ? Label -eq Texture | ? Extension -match "(jpg|png|tga)"

        $Hash     = @{ }
        ForEach ($File in $List)
        {
            $Item           = $This.Q3ALiveAssignmentEditAssetTexture($Hash.Count,$File)

            $Item.SetDisplayName($Item.Fullname.Replace($xTexture.Fullname,""))
            $Item.Reference = $Item.DisplayName.Replace(".$($Item.Extension)","").Replace("\","/").TrimStart("/")
...
Class Q3ALiveController
{
    ...
    GetNotify()
    {
        $This.Notify = $This.Q3ALiveNotifyHelper()
    }
    ...
    AssignmentEditSourceOutput()
    {
        ...
        {
            $Item = $Ctrl.Xaml.IO.AssignmentEditSourceOutput.SelectedItem
            $Ctrl.Assignment.Edit.SetSelected($Item.Index)

            If (!$Item.Source)
            {
                $Ctrl.Xaml.IO.AssignmentEditSourcePathText.Text   = "{0}\{1}" -f $Ctrl.Workspace.Fullname, $Item.DisplayName
            }
            Else
            {
                $Ctrl.Xaml.IO.AssignmentEditSourcePathText.Text   = $Item.Source   
            }
    ...
    AssignmentEditSourcePathUpdate()
    {
        $Ctrl = $This
        ...
        If ($Ctrl.Xaml.IO.AssignmentEditSourceOutput.SelectedIndex -ne -1)
        {
            ...
            # Shader
            $Ctrl.Reset($Ctrl.Xaml.IO.AssignmentEditShaderOutput,$Null)

            $Ctrl.Reset($Ctrl.Xaml.IO.AssignmentEditShaderItemOutput,$Null)
            $Ctrl.Reset($Ctrl.Xaml.IO.AssignmentEditShaderItemContent,$Null)

            # Texture
            $Ctrl.Reset($Ctrl.Xaml.IO.AssignmentEditTextureOutput,$Null)
            ...
            If ($Map.Shader)
            {
                $Ctrl.Reset($Ctrl.Xaml.IO.AssignmentEditShaderOutput,$Map.Shader.File)
            }

            # Textures
            If ($Map.Texture)
            {
                $Ctrl.Reset($Ctrl.Xaml.IO.AssignmentEditTextureOutput,$Map.Texture.File)
            }
    ...
    AssignmentEditSourcePathAssign()
    {
        ...
        If ($Ctrl.Xaml.IO.AssignmentEditSourceOutput.SelectedIndex -ne -1)
        {
            ...
            $Ctrl.AssignmentEditSourcePathUpdate()
        }
    }
    AssignmentEditShaderOutput()
    {
        $Ctrl = $This
        ...
        $Shader = $Ctrl.Xaml.IO.AssignmentEditShaderOutput.SelectedItem
        If ($Shader)
        {
            $Ctrl.Reset($Ctrl.Xaml.IO.AssignmentEditShaderItemOutput,$Shader.Output)
        }
    }
    AssignmentEditShaderItemOutput()
    {
        $Ctrl = $This
        
        $Ctrl.Reset($Ctrl.Xaml.IO.AssignmentEditShaderItemContent,$Null)

        $Item = $Ctrl.Xaml.IO.AssignmentEditShaderItemOutput.SelectedItem
        If ($Item)
        {
            $Ctrl.Reset($Ctrl.Xaml.IO.AssignmentEditShaderItemContent,$Item.Content)
        }
    }
    [Object] FEModule()
    {
    ...
    Stage([String]$Name)
    {
        ...
        Switch ($Name)
        {
            ...
            {  
                ...
                $Ctrl.Xaml.IO.AssignmentEditShaderOutput.Add_SelectionChanged(
                {
                    $Ctrl.AssignmentEditShaderOutput()
                })

                $Ctrl.Xaml.IO.AssignmentEditShaderItemOutput.Add_SelectionChanged(
                {
                    $Ctrl.AssignmentEditShaderItemOutput()
                })
            }
            Steam
            {
