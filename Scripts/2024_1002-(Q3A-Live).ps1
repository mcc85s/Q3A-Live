<#
    ...
    https://steamcommunity.com/sharedfiles/filedetails/?id=539821860
#>

$Mod = Get-Module -Name FightingEntropy -EA 0 | ? Version -eq 2024.1.0
If (!$Mod)
{
...
Class Q3ALiveMaster
{
    ...
    DependencyOutput()
    {
        ...
        # Workspace tab check
        $Select = $Ctrl.Dependency.Output | ? DisplayName -match "(Radiant|Archive|Image)"
