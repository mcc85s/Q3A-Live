...
Class Q3ALiveMaster
{
    ...
    Compile()
    {
        ...
        Else
        {
            ...
            $This.Update(0,"Compiling [~] $($This.Map.Source)")
    ...
    MapArenaApply()
    {
        $This.Update(0,"Setting [~] Arena: $($This.Xaml.IO.MapArenaContent.Text)")
    ...
    MapShaderApply()
    {
        $This.Update(0,"Setting [~] Shader: $($This.Xaml.IO.MapShaderContent.Text)")
